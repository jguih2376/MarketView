...
def app():
    ...
    st.write("""  
        ...
        trazendo informações cruciais para a tomada de decisões inteligentes e embasadas. Explore as diversas 
        funcionalidades do sistema utilizando o menu lateral:
